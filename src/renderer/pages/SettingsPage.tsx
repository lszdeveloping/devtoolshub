  ...
  return (
    <div className="p-8 max-w-2xl mx-auto space-y-8">
      ...
      <div className="card p-5 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="bg-surface-800 rounded-lg p-3">
            ...
            <div className="text-slate-200 font-medium">Windows</div>
          </div>
          <div className="bg-surface-800 rounded-lg p-3">
      ...
      <div className="card p-5 space-y-3">
        ...
        <div className="bg-surface-800 rounded-lg p-3 font-mono text-xs text-slate-400 select-all">$env:Path -split ";"</div>
      </div>
      ...
      <div className="card p-5 space-y-3">
        ...
        <div className="flex gap-4 text-sm text-primary-400">
          <button className="hover:text-primary-300 transition-colors" onClick={() => window.api?.openUrl(repositoryUrl)}>
            GitHub
          </button>
          <button className="hover:text-primary-300 transition-colors" onClick={() => window.api?.openUrl(issuesUrl)}>
            Report Issue
          </button>
        </div>
      </div>
